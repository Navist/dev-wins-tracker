...
const TimeInput = React.forwardRef<HTMLDivElement, TimeInputProps>(
    ({ hourCycle, ...props }: TimeInputProps, ref) => {
        ...
        const locale =
            window !== undefined ? window.navigator.language : "en-US";
                ...
                if (fromMonth) {
                    ...
                    if (presetMonth && presetMonth < fromMonth.getMonth()) {
                        throw new Error(
                            `Preset ${
                                preset.label
                            }'s 'from' is before fromMonth ${format(
                                fromMonth,
                                "MMM, yyyy"
                            )}.`
                        );
                ...
                if (fromDay) {
                    ...
                    if (presetDay && presetDay < fromDay.getDate()) {
                        throw new Error(
                            ...
                            }'s 'from' is before fromDay ${format(
                                fromDay,
                                "MMM dd, yyyy"
                            )}.`
                        );
