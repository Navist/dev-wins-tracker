                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-6">
                                    ...
                                    <div className="col-span-full sm:col-span-3">
                                        ...
                                        <p className="mt-2 text-xs text-gray-500">
                                            Roles can only be changed by system
                                            admin.
                                        </p>
                                    </div>
                    ...
                    <form>
                        <div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
                            <div>
                                ...
                                <p className="mt-1 text-sm leading-6 text-gray-500">
                                    Configure the types of notifications you
                                    want to receive.
                                </p>
                            </div>
                            <div className="md:col-span-2">
                                <fieldset>
                                    ...
                                    <p className="mt-1 text-sm leading-6 text-gray-500">
                                        Configure the types of team alerts you
                                        want to receive.
                                    </p>
                                    <ul
                                        role="list"
                                ...
                                <fieldset className="mt-6">
                                    ...
                                    <p className="mt-1 text-sm leading-6 text-gray-500">
                                        Configure the types of usage alerts you
                                        want to receive.
                                    </p>
                                    <ul
                                        role="list"
                    ...
                    <form>
                        <div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
                            <div>
                                ...
                                <p className="mt-1 text-sm leading-6 text-gray-500">
                                    Manage general workspace. Contact system
                                    ...
                                    <div className="flex items-start justify-between gap-10">
                                        <div>
                                            ...
                                            <p className="mt-2 text-sm leading-6 text-gray-500">
                                                Revoke your access to this team.
                                                Other people you have added to
                                ...
                                <Card className="overflow-hidden p-0">
                                    ...
                                    <div className="border-t border-gray-200 bg-gray-50 p-4 dark:border-gray-900 dark:bg-gray-900">
                                        <p className="text-sm text-gray-500">
                                            You cannot delete the workspace
                                            because you are not the system
                                            admin.
                                        </p>
                                    </div>
                                </Card>
