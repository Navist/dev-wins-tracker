        ...
        <>
            <div className="rounded-lg bg-gray-50 p-6 ring-1 ring-inset ring-gray-200 dark:bg-gray-400/10 dark:ring-gray-800">
                ...
                <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">
                    Boost your analytics and unlock advanced features with our
                    premium plans.{" "}
                    <a
                        href="#"
                    ...
                    <div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
                        <div>
                            ...
                            <p className="mt-1 text-sm leading-6 text-gray-500">
                                Overview of current billing cycle based on fixed
                                and on-demand charges.
                            </p>
                        </div>
                        <div className="md:col-span-2">
                            ...
                            >
                                {data.map((item) => (
                                    <li
                                        key={item.name}
                                        className="px-2 py-4 text-sm md:p-4"
                                    >
                                ...
                                <Card className="overflow-hidden p-0">
                                    <div className="px-4 pb-6 pt-4">
                                        ...
                                        <p className="mt-2 max-w-xl text-sm leading-6 text-gray-500">
                                            Safeguard your assets with our
                                            cutting-edge bot protection. Our AI
                                            solution identifies and mitigates
                                            automated traffic to protect your
                                ...
                                <Card className="overflow-hidden p-0">
                                    <div className="px-4 pb-6 pt-4">
                                        ...
                                        <p className="mt-2 max-w-xl text-sm leading-6 text-gray-500">
                                            ...
                                            workspace&#39;s usage, enabling you
                                            to make well-informed decisions for
                                            optimization.
                                        </p>
                                    </div>
                                    <div className="flex items-center justify-between border-t border-gray-200 bg-gray-50 p-4 dark:border-gray-900 dark:bg-gray-900">
